...
df = pd.read_csv(
    "D:/uni/Python/Pranav_Gryffindor_script/ETL1 (2)/ETL1/data/processed/preprocessed_data.csv")
...
def Lasso():
    ...
    random_search = RandomizedSearchCV(
        model, param_distributions=param_grid, n_iter=100, cv=5, random_state=42)
    return random_search
...
def ExtraTreesRegressor():
    ...
    random_search = RandomizedSearchCV(
        estimator=et_model, param_distributions=param_dist, n_iter=100, cv=5, verbose=1, n_jobs=-1)
...
def train_model(model_id):
    ...
    if model_id in models:
        ...
        with mlflow.start_run():
            ...
            model_path = f"D:/uni/Python/Pranav_Gryffindor_script/ETL1 (2)/ETL1/data/models/model.pkl"
